package site.beanyon.apt.common.constant;
...
public class ThreadPoolConstants {
     ...
     * 核心线程数量，可用处理器的两倍
     */
    public final static int CORE_POOL_SIZE = Runtime.getRuntime().availableProcessors() * 2;
    /**
     * 最大线程数量
     */
    public final static int MAX_POOL_SIZE = CORE_POOL_SIZE * 4;
    /**
     * 任务队列容量
     */
